...
public class PanelReproduccion extends JPanel {
	...
	public void asignarValores() {
		...
		botonRetrocede.setBackground(new Color(160, 32, 240));
		...
		botonAvanza.setBackground(new Color(160, 32, 240));
